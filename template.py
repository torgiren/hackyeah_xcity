...
class Ui_Form(object):
    def setupUi(self, Form):
        Form.setObjectName(_fromUtf8("Dupa"))
        Form.resize(665, 472)
        self.start_button = QtGui.QPushButton(Form)
        self.start_button.setEnabled(False)
        self.start_button.setGeometry(QtCore.QRect(260, 320, 201, 51))
        self.start_button.setObjectName(_fromUtf8("start_button"))
        self.combo_ulica = QtGui.QComboBox(Form)
        self.combo_ulica.setEnabled(False)
        self.combo_ulica.setGeometry(QtCore.QRect(260, 240, 201, 31))
        ...
        self.input_path.setGeometry(QtCore.QRect(80, 113, 521, 31))
        ...
        self.slownik_path.setGeometry(QtCore.QRect(80, 182, 521, 31))
